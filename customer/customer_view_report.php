...
<html>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="background-color: #FAFAFA;">
                                ...
                                if (isset($_POST['search_buton'])) {
                                    ...
                                    $sql_query = "SELECT SQL_CALC_FOUND_ROWS a.cus_id,a.cus_fullname,a.cus_nic,a.cus_address,a.cus_reg_date,a.cus_tp,c.`ser_number` FROM customer a INNER JOIN service c ON a.cus_nic=c.cus_nic WHERE ser_number LIKE 'BLS%' ORDER BY a.cus_id LIMIT " . (($pagination->get_page() - 1) * $records_per_page) . "," . $records_per_page;
                                } else {
                                    $sql_query = "SELECT SQL_CALC_FOUND_ROWS a.cus_id,a.cus_fullname,a.cus_nic,a.cus_address,a.cus_reg_date,a.cus_tp,c.`ser_number` FROM customer a INNER JOIN service c ON a.cus_nic=c.cus_nic WHERE ser_number LIKE 'BLS%' ORDER BY a.cus_id ";
                                }
                                $result = mysqli_query($conn, $sql_query);
                                $service_co = mysqli_num_rows($result);
                                if (!($result)) {
    ...
    <?php } if ($_SESSION['user_branch'] == "Horana") { ?>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="background-color: #FAFAFA;">
                                ...
                                if (isset($_POST['search_buton'])) {
                                    ...
                                    $sql_query = "SELECT SQL_CALC_FOUND_ROWS a.cus_id,a.cus_fullname,a.cus_nic,a.cus_address,a.cus_reg_date,a.cus_tp,c.`ser_number` FROM customer a INNER JOIN service c ON a.cus_nic=c.cus_nic WHERE ser_number LIKE 'HOR%' ORDER BY a.cus_id LIMIT " . (($pagination->get_page() - 1) * $records_per_page) . "," . $records_per_page;
                                } else {
                                    $sql_query = "SELECT SQL_CALC_FOUND_ROWS a.cus_id,a.cus_fullname,a.cus_nic,a.cus_address,a.cus_reg_date,a.cus_tp,c.`ser_number` FROM customer a INNER JOIN service c ON a.cus_nic=c.cus_nic WHERE ser_number LIKE 'HOR%' ORDER BY a.cus_id ";
                                }
                                $result = mysqli_query($conn, $sql_query);
                                $service_co = mysqli_num_rows($result);
                                if (!($result)) {
